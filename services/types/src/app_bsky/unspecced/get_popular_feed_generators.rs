...
#[derive(Serialize, Deserialize, Debug, Clone, PartialEq, Eq, IntoStatic)]
#[serde(rename_all = "camelCase", bound(deserialize = "S: Deserialize<'de> + BosStr"))]
pub struct GetPopularFeedGeneratorsOutput<S: BosStr = DefaultStr> {
    #[serde(skip_serializing_if = "Option::is_none")]
    pub cursor: Option<S>,
...
impl jacquard_common::xrpc::XrpcResp for GetPopularFeedGeneratorsResponse {
    ...
    type Output<S: BosStr> = GetPopularFeedGeneratorsOutput<S>;
    type Err = jacquard_common::xrpc::GenericError;
}

impl<S: BosStr> jacquard_common::xrpc::XrpcRequest for GetPopularFeedGenerators<S> {
    const NSID: &'static str = "app.bsky.unspecced.getPopularFeedGenerators";
...
impl jacquard_common::xrpc::XrpcEndpoint for GetPopularFeedGeneratorsRequest {
    ...
    const METHOD: jacquard_common::xrpc::XrpcMethod = jacquard_common::xrpc::XrpcMethod::Query;
    type Request<S: BosStr> = GetPopularFeedGenerators<S>;
    type Response = GetPopularFeedGeneratorsResponse;
}
