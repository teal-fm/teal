...
pub struct GetLists<S: BosStr = DefaultStr> {
...
#[derive(Serialize, Deserialize, Debug, Clone, PartialEq, Eq, IntoStatic)]
#[serde(rename_all = "camelCase", bound(deserialize = "S: Deserialize<'de> + BosStr"))]
pub struct GetListsOutput<S: BosStr = DefaultStr> {
    #[serde(skip_serializing_if = "Option::is_none")]
    pub cursor: Option<S>,
...
impl jacquard_common::xrpc::XrpcResp for GetListsResponse {
    ...
    type Output<S: BosStr> = GetListsOutput<S>;
    type Err = jacquard_common::xrpc::GenericError;
}

impl<S: BosStr> jacquard_common::xrpc::XrpcRequest for GetLists<S> {
    const NSID: &'static str = "app.bsky.graph.getLists";
...
impl jacquard_common::xrpc::XrpcEndpoint for GetListsRequest {
    ...
    const METHOD: jacquard_common::xrpc::XrpcMethod = jacquard_common::xrpc::XrpcMethod::Query;
    type Request<S: BosStr> = GetLists<S>;
    type Response = GetListsResponse;
}
