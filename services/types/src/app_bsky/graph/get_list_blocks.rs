...
#[derive(Serialize, Deserialize, Debug, Clone, PartialEq, Eq, IntoStatic)]
#[serde(rename_all = "camelCase", bound(deserialize = "S: Deserialize<'de> + BosStr"))]
pub struct GetListBlocksOutput<S: BosStr = DefaultStr> {
    #[serde(skip_serializing_if = "Option::is_none")]
    pub cursor: Option<S>,
...
impl jacquard_common::xrpc::XrpcResp for GetListBlocksResponse {
    ...
    type Output<S: BosStr> = GetListBlocksOutput<S>;
    type Err = jacquard_common::xrpc::GenericError;
}

impl<S: BosStr> jacquard_common::xrpc::XrpcRequest for GetListBlocks<S> {
    const NSID: &'static str = "app.bsky.graph.getListBlocks";
...
impl jacquard_common::xrpc::XrpcEndpoint for GetListBlocksRequest {
    ...
    const METHOD: jacquard_common::xrpc::XrpcMethod = jacquard_common::xrpc::XrpcMethod::Query;
    type Request<S: BosStr> = GetListBlocks<S>;
    type Response = GetListBlocksResponse;
}
