...
//
// Lexicon: fm.teal.stats.getUserTopArtists
//
...
/// Response type for fm.teal.stats.getUserTopArtists
pub struct GetUserTopArtistsResponse;
impl jacquard_common::xrpc::XrpcResp for GetUserTopArtistsResponse {
    const NSID: &'static str = "fm.teal.stats.getUserTopArtists";
...
/// Endpoint type for fm.teal.stats.getUserTopArtists
pub struct GetUserTopArtistsRequest;
impl jacquard_common::xrpc::XrpcEndpoint for GetUserTopArtistsRequest {
    const PATH: &'static str = "/xrpc/fm.teal.stats.getUserTopArtists";
    const METHOD: jacquard_common::xrpc::XrpcMethod = jacquard_common::xrpc::XrpcMethod::Query;
