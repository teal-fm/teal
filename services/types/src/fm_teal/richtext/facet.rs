...
//
// Lexicon: fm.teal.richtext.facet
//
...
impl<S: BosStr> LexiconSchema for Facet<S> {
    fn nsid() -> &'static str {
        "fm.teal.richtext.facet"
    }
    fn def_name() -> &'static str {
        "main"
    }
    fn lexicon_doc() -> LexiconDoc<'static> {
        lexicon_doc_fm_teal_richtext_facet()
    }
...
fn lexicon_doc_fm_teal_richtext_facet() -> LexiconDoc<'static> {
    #[allow(unused_imports)]
    ...
    LexiconDoc {
        ...
        id: CowStr::new_static("fm.teal.richtext.facet"),
        defs: {
