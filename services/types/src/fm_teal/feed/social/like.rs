...
//
// Lexicon: fm.teal.feed.social.like
//
...
#[serde(
    ...
    rename = "fm.teal.feed.social.like",
    tag = "$type",
...
impl XrpcResp for LikeRecord {
    const NSID: &'static str = "fm.teal.feed.social.like";
...
impl<S: BosStr> LexiconSchema for Like<S> {
    ...
    fn lexicon_doc() -> LexiconDoc<'static> {
        lexicon_doc_fm_teal_feed_social_like()
    }
...
fn lexicon_doc_fm_teal_feed_social_like() -> LexiconDoc<'static> {
    #[allow(unused_imports)]
    ...
    LexiconDoc {
        ...
        id: CowStr::new_static("fm.teal.feed.social.like"),
        defs: {
