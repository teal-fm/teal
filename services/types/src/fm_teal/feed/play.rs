...
impl XrpcResp for PlayRecord {
    const NSID: &'static str = "fm.teal.feed.play";
    ...
    St::TrackName: play_state::IsSet,
{
    ...
    pub fn build(self) -> Play<S> {
        Play {
            ...
            isrc: self._fields.4,
            music_service_uri: self._fields.5,
            origin_uri: self._fields.6,
...
fn lexicon_doc_fm_teal_feed_play() -> LexiconDoc<'static> {
    #[allow(unused_imports)]
    ...
    LexiconDoc {
        ...
        id: CowStr::new_static("fm.teal.feed.play"),
        defs: {
