...
//
// Lexicon: fm.teal.alpha.feed.social.like
//
...
/// Record containing a like for a teal.fm post.

#[derive(Serialize, Deserialize, Debug, Clone, PartialEq, Eq, IntoStatic)]
#[serde(
    rename_all = "camelCase",
    rename = "fm.teal.alpha.feed.social.like",
    tag = "$type",
...
pub struct Like<S: BosStr = DefaultStr> {
    ...
    ///Strong reference to the record being liked.
...
impl XrpcResp for LikeRecord {
    const NSID: &'static str = "fm.teal.alpha.feed.social.like";
...
impl<S: BosStr> LexiconSchema for Like<S> {
    ...
    fn lexicon_doc() -> LexiconDoc<'static> {
        lexicon_doc_fm_teal_alpha_feed_social_like()
    }
...
fn lexicon_doc_fm_teal_alpha_feed_social_like() -> LexiconDoc<'static> {
    #[allow(unused_imports)]
    ...
    LexiconDoc {
        ...
        id: CowStr::new_static("fm.teal.alpha.feed.social.like"),
        defs: {
