...
//
// Lexicon: fm.teal.alpha.feed.social.playlistItem
//
...
#[serde(
    ...
    rename = "fm.teal.alpha.feed.social.playlistItem",
    tag = "$type",
...
pub struct PlaylistItem<S: BosStr = DefaultStr> {
    ...
    ///The track added to the playlist.
...
impl XrpcResp for PlaylistItemRecord {
    const NSID: &'static str = "fm.teal.alpha.feed.social.playlistItem";
...
impl<S: BosStr> LexiconSchema for PlaylistItem<S> {
    ...
    fn lexicon_doc() -> LexiconDoc<'static> {
        lexicon_doc_fm_teal_alpha_feed_social_playlistItem()
    }
...
fn lexicon_doc_fm_teal_alpha_feed_social_playlistItem() -> LexiconDoc<'static> {
    #[allow(unused_imports)]
    ...
    LexiconDoc {
        ...
        id: CowStr::new_static("fm.teal.alpha.feed.social.playlistItem"),
        defs: {
