...
//
// Lexicon: fm.teal.alpha.graph.follow
//
...
#[serde(
    ...
    rename = "fm.teal.alpha.graph.follow",
    tag = "$type",
...
impl XrpcResp for FollowRecord {
    const NSID: &'static str = "fm.teal.alpha.graph.follow";
...
impl<S: BosStr> LexiconSchema for Follow<S> {
    ...
    fn lexicon_doc() -> LexiconDoc<'static> {
        lexicon_doc_fm_teal_alpha_graph_follow()
    }
...
fn lexicon_doc_fm_teal_alpha_graph_follow() -> LexiconDoc<'static> {
    #[allow(unused_imports)]
    ...
    LexiconDoc {
        ...
        id: CowStr::new_static("fm.teal.alpha.graph.follow"),
        defs: {
