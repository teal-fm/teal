...
//
// Lexicon: fm.teal.alpha.graph.getFollowers
//
...
/// Response type for fm.teal.alpha.graph.getFollowers
pub struct GetFollowersResponse;
impl jacquard_common::xrpc::XrpcResp for GetFollowersResponse {
    const NSID: &'static str = "fm.teal.alpha.graph.getFollowers";
...
/// Endpoint type for fm.teal.alpha.graph.getFollowers
pub struct GetFollowersRequest;
impl jacquard_common::xrpc::XrpcEndpoint for GetFollowersRequest {
    const PATH: &'static str = "/xrpc/fm.teal.alpha.graph.getFollowers";
    const METHOD: jacquard_common::xrpc::XrpcMethod = jacquard_common::xrpc::XrpcMethod::Query;
