...
//
// Lexicon: fm.teal.alpha.search.defs
//
...
impl<S: BosStr> LexiconSchema for SongResult<S> {
    fn nsid() -> &'static str {
        "fm.teal.alpha.search.defs"
    }
    fn def_name() -> &'static str {
        "songResult"
    }
    fn lexicon_doc() -> LexiconDoc<'static> {
        lexicon_doc_fm_teal_alpha_search_defs()
    }
...
fn lexicon_doc_fm_teal_alpha_search_defs() -> LexiconDoc<'static> {
    #[allow(unused_imports)]
    ...
    LexiconDoc {
        ...
        id: CowStr::new_static("fm.teal.alpha.search.defs"),
        defs: {
