...
pub type BlockedAuthor = atrium_api::types::Object<BlockedAuthorData>;
#[derive(serde::Serialize, serde::Deserialize, Debug, Clone, PartialEq, Eq)]
#[serde(rename_all = "camelCase")]
...
pub type BlockedPost = atrium_api::types::Object<BlockedPostData>;
...
pub type GeneratorView = atrium_api::types::Object<GeneratorViewData>;
#[derive(serde::Serialize, serde::Deserialize, Debug, Clone, PartialEq, Eq)]
#[serde(rename_all = "camelCase")]
...
pub type GeneratorViewerState = atrium_api::types::Object<GeneratorViewerStateData>;
#[derive(serde::Serialize, serde::Deserialize, Debug, Clone, PartialEq, Eq)]
#[serde(rename_all = "camelCase")]
...
pub type NotFoundPost = atrium_api::types::Object<NotFoundPostData>;
#[derive(serde::Serialize, serde::Deserialize, Debug, Clone, PartialEq, Eq)]
#[serde(rename_all = "camelCase")]
pub struct PostViewData {
    ...
    pub cid: atrium_api::types::string::Cid,
    #[serde(skip_serializing_if = "core::option::Option::is_none")]
    pub embed: core::option::Option<atrium_api::types::Union<PostViewEmbedRefs>>,
    pub indexed_at: atrium_api::types::string::Datetime,
    #[serde(skip_serializing_if = "core::option::Option::is_none")]
    pub labels: core::option::Option<Vec<crate::com::atproto::label::defs::Label>>,
    #[serde(skip_serializing_if = "core::option::Option::is_none")]
...
pub type ReasonPin = atrium_api::types::Object<ReasonPinData>;
#[derive(serde::Serialize, serde::Deserialize, Debug, Clone, PartialEq, Eq)]
#[serde(rename_all = "camelCase")]
...
pub struct ReplyRefData {
    ...
    >,
    pub parent: atrium_api::types::Union<ReplyRefParentRefs>,
    pub root: atrium_api::types::Union<ReplyRefRootRefs>,
}
...
pub struct SkeletonFeedPostData {
    ...
    pub reason: core::option::Option<
        atrium_api::types::Union<SkeletonFeedPostReasonRefs>,
    >,
}
pub type SkeletonFeedPost = atrium_api::types::Object<SkeletonFeedPostData>;
#[derive(serde::Serialize, serde::Deserialize, Debug, Clone, PartialEq, Eq)]
#[serde(rename_all = "camelCase")]
pub struct SkeletonReasonPinData {}
pub type SkeletonReasonPin = atrium_api::types::Object<SkeletonReasonPinData>;
#[derive(serde::Serialize, serde::Deserialize, Debug, Clone, PartialEq, Eq)]
#[serde(rename_all = "camelCase")]
pub struct SkeletonReasonRepostData {
    pub repost: String,
}
pub type SkeletonReasonRepost = atrium_api::types::Object<SkeletonReasonRepostData>;
...
pub type ThreadContext = atrium_api::types::Object<ThreadContextData>;
#[derive(serde::Serialize, serde::Deserialize, Debug, Clone, PartialEq, Eq)]
#[serde(rename_all = "camelCase")]
pub struct ThreadViewPostData {
    #[serde(skip_serializing_if = "core::option::Option::is_none")]
    pub parent: core::option::Option<atrium_api::types::Union<ThreadViewPostParentRefs>>,
    pub post: PostView,
    #[serde(skip_serializing_if = "core::option::Option::is_none")]
    pub replies: core::option::Option<
        Vec<atrium_api::types::Union<ThreadViewPostRepliesItem>>,
    >,
    #[serde(skip_serializing_if = "core::option::Option::is_none")]
    pub thread_context: core::option::Option<ThreadContext>,
}
pub type ThreadViewPost = atrium_api::types::Object<ThreadViewPostData>;
#[derive(serde::Serialize, serde::Deserialize, Debug, Clone, PartialEq, Eq)]
#[serde(rename_all = "camelCase")]
...
pub type ThreadgateView = atrium_api::types::Object<ThreadgateViewData>;
