...
//!Definitions for the `fm.teal.alpha.stats.getUserTopArtists` namespace.
//!Get a user's top artists by play count
pub const NSID: &str = "fm.teal.alpha.stats.getUserTopArtists";
...
pub struct OutputData {
    pub artists: Vec<crate::fm::teal::alpha::stats::defs::ArtistView>,
    ///Next page cursor
    #[serde(skip_serializing_if = "core::option::Option::is_none")]
    pub cursor: core::option::Option<String>,
}
