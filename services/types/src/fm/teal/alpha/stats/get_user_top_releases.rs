...
//!Definitions for the `fm.teal.alpha.stats.getUserTopReleases` namespace.
//!Get a user's top releases/albums by play count
pub const NSID: &str = "fm.teal.alpha.stats.getUserTopReleases";
...
pub struct OutputData {
    ...
    #[serde(skip_serializing_if = "core::option::Option::is_none")]
    pub cursor: core::option::Option<String>,
    pub releases: Vec<crate::fm::teal::alpha::stats::defs::ReleaseView>,
}
