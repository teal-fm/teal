...
- CI lexicon build recovery (2026-08-13): Aqua and Cadet Docker builds now generate ignored Rust bindings with Jacquard 0.12.1, and tracked bindings were regenerated so Lexicon Validation matches the merged PR state. Local Aqua/Cadet checks and Dockerfile validation pass; GitHub rerun is in progress.
