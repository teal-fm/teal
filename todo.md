...
- Amethyst Home renders one mixed global feed with social posts and listens sorted together by play `playedTime`, falling back to record `createdAt` when no play timestamp exists.
