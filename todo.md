...
- [x] Fix PR CI setup by moving the shared GitHub Actions Node runtime to 22 for pnpm 11 compatibility, skipping duplicate postinstall lexicon generation in CI, and committing regenerated Rust lexicon bindings.
