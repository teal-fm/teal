...
- Manual-listen review fixes (2026-08-11): Cadet retry jobs now collapse by logical record, preserve commit ordering, reset attempts when newer revisions replace queued retries, recheck account activity, and conditionally complete stale jobs; duplicate-CID retries repair artist links and aggregates, and reverse timeline backfills use the preceding track duration. Focused Rust, TypeScript, Biome, and migration checks pass.
