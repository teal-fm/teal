...
- Top albums chart (2026-09-25): [PR #231](https://github.com/teal-fm/teal/pull/231) is stacked on `fix/album-tracklist-and-cover-art`. Temporary public preview: `https://zone-frontpage-tracked-homework.trycloudflare.com/profile/did:plc:tas6hj2xjrqben5653v5kohk/topster?period=all&size=3`. Amethyst runs from this branch on Patrick through a Cloudflare quick tunnel; `/xrpc/*` forwards over SSH to Aqua on Tashi. The quick-tunnel hostname is ephemeral and the preview depends on the Expo, Caddy, cloudflared, and SSH-forward processes staying up. The public chart route, metadata, and top-albums XRPC were verified. Browser visual QA and PNG download QA remain to be done.
