export const SpaceButton = ({ children }: { children: React.ReactNode }) => {
  return (
    <div className="group container p-0 m-0 z-10 sticky noisey border border-stone-800/20 max-w-min overflow-hidden rounded-full top-4 bg-transparent shadow-inner shadow-stone-200 dark:shadow-stone-800 *:transition-colors">
      <div className="absolute inset-0 blurry container-pad bg-teal-300 dark:bg-teal-800 group-hover:bg-teal-200 dark:group-hover:bg-teal-700 transition-colors" />
